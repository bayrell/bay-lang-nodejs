...
BayLang.Compiler.Commands.Modules = class extends use("Runtime.Console.BaseCommand")
{
	/**
	 * Returns name
	 */
	...
	static async showModules(verbose)
	{
		...
		let modules_names = rtl.list(modules.keys()).sort();
		for (let i = 0; i < modules_names.count(); i++)
		{
