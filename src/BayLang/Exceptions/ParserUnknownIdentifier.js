...
BayLang.Exceptions.ParserUnknownError = function(s, code, prev)
{
	...
	use("Runtime.Exceptions.RuntimeException").call(this, s, code, prev);
};
BayLang.Exceptions.ParserUnknownError.prototype = Object.create(use("Runtime.Exceptions.RuntimeException").prototype);
...
Object.assign(BayLang.Exceptions.ParserUnknownError, use("Runtime.Exceptions.RuntimeException"));
