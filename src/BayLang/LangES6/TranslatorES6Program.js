...
BayLang.LangES6.TranslatorES6Program = function(ctx, translator)
{
	use("Runtime.BaseObject").call(this, ctx);
	this.translator = translator;
};
BayLang.LangES6.TranslatorES6Program.prototype = Object.create(use("Runtime.BaseObject").prototype);
...
Object.assign(BayLang.LangES6.TranslatorES6Program.prototype,
{
	...
	{
		this.current_namespace_name = op_code.name;
	},
	/**
	 * OpUse
	 */
	OpUse: function(ctx, op_code, result)
	{
		...
		this.translator.uses.set(ctx, op_code.alias, __v0.split(ctx, ".", op_code.name));
	},
	/**
	 * OpAnnotation
	 */
...
Object.assign(BayLang.LangES6.TranslatorES6Program, use("Runtime.BaseObject"));
