...
BayLang.LangPHP.TranslatorPHPExpression = function(ctx, translator)
{
	use("Runtime.BaseObject").call(this, ctx);
	this.translator = translator;
};
BayLang.LangPHP.TranslatorPHPExpression.prototype = Object.create(use("Runtime.BaseObject").prototype);
BayLang.LangPHP.TranslatorPHPExpression.prototype.constructor = BayLang.LangPHP.TranslatorPHPExpression;
Object.assign(BayLang.LangPHP.TranslatorPHPExpression.prototype,
{
	...
	OpIdentifier: function(ctx, op_code, result)
	{
		...
		{
			result.push(ctx, "echo");
		}
		else
		{
			result.push(ctx, "$" + use("Runtime.rtl").toStr(op_code.value));
		}
...
Object.assign(BayLang.LangPHP.TranslatorPHPExpression, use("Runtime.BaseObject"));
