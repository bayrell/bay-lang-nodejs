...
BayLang.LangPHP.TranslatorPHPOperator = function(ctx, translator)
{
	use("Runtime.BaseObject").call(this, ctx);
	this.translator = translator;
};
BayLang.LangPHP.TranslatorPHPOperator.prototype = Object.create(use("Runtime.BaseObject").prototype);
BayLang.LangPHP.TranslatorPHPOperator.prototype.constructor = BayLang.LangPHP.TranslatorPHPOperator;
Object.assign(BayLang.LangPHP.TranslatorPHPOperator.prototype,
{
	...
	translateItem: function(ctx, op_code, result)
	{
		...
		{
			return this.OpAssign(ctx, op_code, result);
		}
...
Object.assign(BayLang.LangPHP.TranslatorPHPOperator, use("Runtime.BaseObject"));
