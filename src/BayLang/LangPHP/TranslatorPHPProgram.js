...
BayLang.LangPHP.TranslatorPHPProgram = function(ctx, translator)
{
	use("Runtime.BaseObject").call(this, ctx);
	this.translator = translator;
};
BayLang.LangPHP.TranslatorPHPProgram.prototype = Object.create(use("Runtime.BaseObject").prototype);
BayLang.LangPHP.TranslatorPHPProgram.prototype.constructor = BayLang.LangPHP.TranslatorPHPProgram;
Object.assign(BayLang.LangPHP.TranslatorPHPProgram.prototype,
{
	...
	OpNamespace: function(ctx, op_code, result)
	{
		...
		result.push(ctx, this.translator.getModuleName(ctx, op_code.name));
		result.push(ctx, ";");
	...
	translateItems: function(ctx, items, result)
	{
		...
		for (var i = 0; i < items.count(ctx); i++)
		{
			...
			last_result = this.translateItem(ctx, items.get(ctx, i), result);
		}
	},
	/**
	 * Translate
...
Object.assign(BayLang.LangPHP.TranslatorPHPProgram, use("Runtime.BaseObject"));
