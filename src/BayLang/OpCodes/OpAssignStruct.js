...
BayLang.OpCodes.OpAssignStruct = class extends use("BayLang.OpCodes.BaseOpCode")
{
	/**
	 * Serialize object
	 */
	...
	static getClassName(){ return "BayLang.OpCodes.OpAssignStruct"; }
...
module.exports = {
	"OpAssignStruct": BayLang.OpCodes.OpAssignStruct,
};