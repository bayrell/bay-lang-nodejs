...
BayLang.OpCodes.OpBreak = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpBreak.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpBreak, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpBreak);
module.exports = BayLang.OpCodes.OpBreak;