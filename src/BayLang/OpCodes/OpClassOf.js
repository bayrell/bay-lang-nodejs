...
BayLang.OpCodes.OpClassOf = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpClassOf.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpClassOf, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpClassOf);
module.exports = BayLang.OpCodes.OpClassOf;