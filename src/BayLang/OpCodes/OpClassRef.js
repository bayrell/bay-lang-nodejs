...
BayLang.OpCodes.OpClassRef = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpClassRef.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpClassRef, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpClassRef);
module.exports = BayLang.OpCodes.OpClassRef;