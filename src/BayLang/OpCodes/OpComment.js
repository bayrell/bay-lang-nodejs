...
BayLang.OpCodes.OpComment = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpComment.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpComment, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpComment);
module.exports = BayLang.OpCodes.OpComment;