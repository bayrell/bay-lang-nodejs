...
BayLang.OpCodes.OpCurryArg = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpCurryArg.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpCurryArg, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpCurryArg);
module.exports = BayLang.OpCodes.OpCurryArg;