...
BayLang.OpCodes.OpDeclareFunctionArg = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpDeclareFunctionArg.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpDeclareFunctionArg, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpDeclareFunctionArg);
module.exports = BayLang.OpCodes.OpDeclareFunctionArg;