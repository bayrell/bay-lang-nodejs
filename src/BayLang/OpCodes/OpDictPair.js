...
BayLang.OpCodes.OpDictPair = class extends use("BayLang.OpCodes.BaseOpCode")
{
	/**
	 * Serialize object
	 */
	...
	static getClassName(){ return "BayLang.OpCodes.OpDictPair"; }
...
module.exports = {
	"OpDictPair": BayLang.OpCodes.OpDictPair,
};