...
BayLang.OpCodes.OpHtmlAttribute = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpHtmlAttribute.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpHtmlAttribute.prototype,
{
	...
	serialize: function(ctx, serializer, data)
	{
		...
		serializer.process(ctx, this, "is_spread", data);
...
Object.assign(BayLang.OpCodes.OpHtmlAttribute, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpHtmlAttribute);
module.exports = BayLang.OpCodes.OpHtmlAttribute;