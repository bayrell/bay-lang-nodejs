...
BayLang.OpCodes.OpHtmlContent = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpHtmlContent.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpHtmlContent, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpHtmlContent);
module.exports = BayLang.OpCodes.OpHtmlContent;