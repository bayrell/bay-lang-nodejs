...
BayLang.OpCodes.OpMath = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpMath.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpMath.prototype,
{
	...
	serialize: function(ctx, serializer, data)
	{
		...
		serializer.process(ctx, this, "math", data);
...
Object.assign(BayLang.OpCodes.OpMath, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpMath);
module.exports = BayLang.OpCodes.OpMath;