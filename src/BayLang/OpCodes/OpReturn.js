...
BayLang.OpCodes.OpReturn = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpReturn.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpReturn, use("BayLang.OpCodes.BaseOpCode"));
...
module.exports = BayLang.OpCodes.OpReturn;