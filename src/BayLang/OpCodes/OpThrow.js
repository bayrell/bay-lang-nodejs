...
BayLang.OpCodes.OpThrow = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpThrow.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpThrow, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpThrow);
module.exports = BayLang.OpCodes.OpThrow;