...
BayLang.OpCodes.OpTryCatchItem = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpTryCatchItem.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpTryCatchItem, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpTryCatchItem);
module.exports = BayLang.OpCodes.OpTryCatchItem;