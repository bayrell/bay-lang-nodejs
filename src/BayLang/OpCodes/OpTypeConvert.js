...
BayLang.OpCodes.OpTypeConvert = class extends use("BayLang.OpCodes.BaseOpCode")
{
	/**
	 * Serialize object
	 */
	...
	static getClassName(){ return "BayLang.OpCodes.OpTypeConvert"; }
...
module.exports = {
	"OpTypeConvert": BayLang.OpCodes.OpTypeConvert,
};