...
BayLang.OpCodes.OpWhile = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpWhile.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
});use.add(BayLang.OpCodes.OpWhile);
module.exports = BayLang.OpCodes.OpWhile;