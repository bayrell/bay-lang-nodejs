...
BayLang.OpCodes.OpWidgetData = function(ctx)
{
	use("BayLang.OpCodes.BaseOpCode").apply(this, arguments);
};
BayLang.OpCodes.OpWidgetData.prototype = Object.create(use("BayLang.OpCodes.BaseOpCode").prototype);
...
Object.assign(BayLang.OpCodes.OpWidgetData, use("BayLang.OpCodes.BaseOpCode"));
...
});use.add(BayLang.OpCodes.OpWidgetData);
module.exports = BayLang.OpCodes.OpWidgetData;