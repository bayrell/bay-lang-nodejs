...
Runtime.Providers.OutputProvider = class extends use("Runtime.BaseProvider")
{
	...
	color(color, message)
	{
		...
		message = rs.chr(27) + String("[") + String(color) + String("m") + String(message);
		message = message + String(rs.chr(27)) + String("[0m");
		return message;
	}
...
module.exports = {
	"OutputProvider": Runtime.Providers.OutputProvider,
};