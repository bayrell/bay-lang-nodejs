...
Runtime.Serializer.ConstantType = class extends use("Runtime.BaseObject")
{
	/**
	 * Create object
	 */
...
use.add(Runtime.Serializer.ConstantType);
module.exports = {
	"ConstantType": Runtime.Serializer.ConstantType,
};